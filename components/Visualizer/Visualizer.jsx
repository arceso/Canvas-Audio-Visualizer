...
export default class extends React.Component {
  ...
  componentDidMount() {
    ...
    function renderFrame() {
      ...
      let shadowWidth = DATA_ARRAY[Math.ceil(DATA_ARRAY.length / 2)];
      ...
      circleShadow.fillColor = {
        gradient: {
            stops: [['#ff0050', shadowWidth / 300], ['transparent', 1]],
            radial: true
        },
      ...
      if (DATA_ARRAY.every(level => level > 50)) {
        ...
        circle.position = [
          getRandomInt(x + 5, x - 5),
          getRandomInt(y + 5, y - 5)
        ];
      }
    }
    ...
    function bisection(currentAngle) {
      return currentAngle + DEGS_PER_LINE / 2;
    }
  }
...
function roundNumber(number, decimals = 5) {
